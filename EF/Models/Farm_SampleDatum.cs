...
/// عينة سحب المزرعة
/// </summary>
public partial class Farm_SampleDatum
{
    ...
    public virtual Farm_Request_ItemCategory Farm_Request_ItemCategories { get; set; } = null!;

    public virtual ICollection<Farm_SampleData_Confirm> Farm_SampleData_Confirms { get; set; } = new List<Farm_SampleData_Confirm>();
}
